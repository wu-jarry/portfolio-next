...
import { RectAreaLightSource } from '@/app/(home–components)/(room)/lights'; // Import RectAreaLightSource
...
export function RoomModel({ ...props }) {
  ...
  const [coverCubeScale, setCoverCubeScale] = useState(18.648);
  ...
  // change this to cover cube I need to make a new useSpring
  ...
  const [lightOnSpringProps] = useSpring(() => ({
      lightIntensity: animationsFinished ? 1 : 0,
      config: {
          duration: 400
      }
  }), [animationsFinished]);
    ...
    <>
      ...
      <animated.group ref={group} {...props} dispose={null}>
        <group name="Scene">
          ...
          <group name="Computer" position={[33.668, 5.176, 3.196]}>
            {/* @ts-ignore */}
            <animated.group name='Computer' onClick={() => setMonitorClick(true)} onPointerOver={monitorCoverHover} onPointerOut={monitorCoverUnhover} scale={monitorSpringProps.monitorScale} position={monitorSpringProps.monitorPosition}>
              <mesh
                name="Cube014"
                // castShadow
                receiveShadow
              ...
              <Html position={[0, 2.4 + arrowBounce, 0.6]} rotation={[-Math.PI/4, -Math.PI/4, -Math.PI/4]}
                style={{
                  transition: '0.5s', 
