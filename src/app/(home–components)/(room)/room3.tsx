...
export function RoomModel({ ...props }) {
  ...
  }), [coverCubeScale, isCoverHovered]);

  const arrowSpringProps = useSpring(() => ({
    scale: (isCoverHovered ? 1 : 0),
    config: {
      duration: 400
    },
  }), [isCoverHovered]);
  ...
  return (
    <div>
         <animated.svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" >
      ...
      <animated.group ref={group} {...props} dispose={null}>
        <group name="Scene">
          ...
          />
            <Html position={[0, 17, 0]} style={{scale: 1}}>
