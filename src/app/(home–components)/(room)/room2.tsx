...
export function RoomModel({ animationState, progressAnimationState, ...props }: RoomModelProps) {
  ...
  const { nodes, materials, animations } = useGLTF("/models/website ver2 beta.glb") as GLTFResult;
    ...
    <animated.group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh
          ...
          castShadow
          receiveShadow
          geometry={nodes.Entrance_matt.geometry}
        ...
        <group name="Plane" position={[0.553, 12.167, -6.783]} scale={8.75}>
          <mesh
            name="Plane022"
            castShadow
            receiveShadow
...
useGLTF.preload("/models/website ver2 beta.glb");
